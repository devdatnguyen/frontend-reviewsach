         ...
         {histories.length > 0 ? 
          <>
            ...
            {histories.map(history => (
                <div key={history.title + history.checkoutDate} className="card mt-3 shadow p-3 mb-3 bg-body rounded">
                        ...
                        <div className="col-md-2">
                            <div className="d-none d-lg-block">
                                {history.img?
                                    ...
                                    :
                                    <img src="https://via.placeholder.com/123x196" width={123} height={196} alt="Default" />
                                }
                            </div>
