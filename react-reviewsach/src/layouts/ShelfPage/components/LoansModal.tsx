...
export const LoansModal:React.FC<{shelfCurrentLoan: ShelfCurrentLoans, moblie: boolean, returnBook: any
        renewLoan: any}> = (props) =>{
    return(
        <div className="modal fade" id= {props.moblie? `mobilemodal${props.shelfCurrentLoan.book.id}`:
                                    ...
                                    <div className="row">
                                        <div className="col-2">
                                            {props.shelfCurrentLoan.book?.img?
                                                ...
                                                width='56' height='87'/>
                                                :
                                                <img src="https://via.placeholder.com/56x87.png?text=No+Image" alt="Book"
                                                width={56} height={87} />
                                            }
                                        </div>
